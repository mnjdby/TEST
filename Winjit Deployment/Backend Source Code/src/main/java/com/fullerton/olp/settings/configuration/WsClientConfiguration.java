...
public class WsClientConfiguration {
	...
	@Bean
	public ConnectPlusDAO createConnectPlusClient(Jaxb2Marshaller cpMarshaller) {
	...
	@Bean
	public CrmNextDAO createCrmClient(Jaxb2Marshaller crmMarshaller) {
	...
	@Bean
	public BreDAO createBreClient(Jaxb2Marshaller breMarshaller) {
