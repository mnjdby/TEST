...
import static com.fullerton.olp.Constant.PAGE_SIZE;
...
import com.fullerton.olp.repository.support.OrderByDirection;
import com.fullerton.olp.repository.support.SearchMode;
import com.fullerton.olp.repository.support.SearchTemplate;

/**
 * Holds extra informations to be displayed and filled by the spring mvc
 * {@link Controller}.
 */
public class SearchParameters implements Serializable {
	...
	/**
	 * Limit the search to the passed page number. Must be positive (starts at
	...
	/**
	 * Returns the page number used to limit the search. It is always positive
	 * (starts at 1).
	 */
	...
	/**
	 * Set the max number of items that can be displayed per page. The page size
	 * must be positive (starts at 1). It is used to limit the search.
	 */
	 ...
	 *
	 * @param sortOrder
	 *            either ASCENDING, DESCENDING or an empty String
	 */
	...
	/**
	 * Return the reverse Sort Order for the passed columns. It is used by the
	 * view.
	 *
	...
	/**
	 * Set the search pattern to apply to all string fields for executing the
	 * search.
	 *
	 * @param searchPattern
	 */
	...
	/**
	 * Returns the search pattern that must be applied to all string fields when
	...
	/**
	 * Convert this searchParameters instance to a SearchTemplate. Copy all the
	 * property and calculate the first and max results properties depending on
	 * the pageSize and pageNumber properties of the passed searchParameters.
	 *
	...
	public SearchTemplate toSearchTemplate() {
		...
		log.info("PageNumber :->" + getPageNumber());
		log.info("PageSize :->" + getPageSize());
		searchTemplate.setPageNumber(getPageNumber());
