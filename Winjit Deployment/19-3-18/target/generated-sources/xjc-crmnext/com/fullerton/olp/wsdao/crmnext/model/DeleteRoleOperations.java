 ...
 *         &lt;element name="OperationIds" type="{http://schemas.microsoft.com/2003/10/Serialization/Arrays}ArrayOfint" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "DeleteRoleOperations")
public class DeleteRoleOperations
    implements Serializable
{
    ...
    @XmlElementRef(name = "OperationIds", namespace = "http://www.crmnext.com/api/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfint> operationIds;
     ...
     *     
     */
    public JAXBElement<ArrayOfint> getOperationIds() {
        return operationIds;
    }

    /**
     * Sets the value of the operationIds property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfint }{@code >}
     *     
     */
    public void setOperationIds(JAXBElement<ArrayOfint> value) {
