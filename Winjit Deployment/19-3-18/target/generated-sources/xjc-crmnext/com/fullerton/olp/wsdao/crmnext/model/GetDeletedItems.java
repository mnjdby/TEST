 ...
 *         &lt;element name="objectid" type="{http://schemas.microsoft.com/2003/10/Serialization/Arrays}ArrayOfint" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetDeletedItems")
public class GetDeletedItems
    implements Serializable
{
    ...
    @XmlElementRef(name = "objectid", namespace = "http://www.crmnext.com/api/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfint> objectid;
     ...
     *     
     */
    public JAXBElement<ArrayOfint> getObjectid() {
        return objectid;
    }
     ...
     *     
     */
    public void setObjectid(JAXBElement<ArrayOfint> value) {
        this.objectid = value;
    }
