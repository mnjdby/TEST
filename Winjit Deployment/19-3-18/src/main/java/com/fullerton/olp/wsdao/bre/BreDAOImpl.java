...
public class BreDAOImpl extends WebServiceGatewaySupport implements BreDAO {
	...
	/* (non-Javadoc)
	 * @see com.fullerton.olp.wsdao.bre.BreDAO#invokeBRE(com.fullerton.olp.wsdao.cp.model.FetchOutputNewApplicationXML, com.fullerton.olp.model.UserDetail)
	 */
	...
	private String getObjectDataText(FetchOutputNewApplicationXML fetchOutputNewApplicationXML,UserDetail userDetail) {
		...
		objectDataMap.put("officeLandlineNumber",userDetail.getProfessionalDetail().getWorkAddress().getLandline()==null?"":userDetail.getProfessionalDetail().getWorkAddress().getLandline());
